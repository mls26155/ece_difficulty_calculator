                ...
                <div className="flex gap-2">
                  <div className="grid m-2 my-4">
                    ...
                    <div className="col-start-1 z-10 row-start-1">
                      <Image src="/James.png" alt="James Photo" width="145" height="100" className="rounded"/>
                    </div>
                  </div>
                  <div className="p-2 p-y-0">
                    <h2 className="scroll-m-20 text-xl font-semibold tracking-tight m-2">Difficulty Level</h2>
                    <h1 className="text-red-600 text-4xl font-extrabold m-2 my-3">1/10</h1>
                    <p className="italic text-sm m-2 my-3">&quot;I did that class in my sleep.&quot; -James Yang</p>
                  </div>
                </div>
              </CardHeader>
            </Card>
